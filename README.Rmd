...
As observed by the above table, KDA ratio, gold per minute, and champions killed all had correlation coefficients near 1, indicating strong positive correlations.  In addition, each of the p-values for those 3 results were well under the 0.05 threshold, making them statistically significant.
