...
```{r,echo=FALSE}
cor.test(LCS.table$Win.Rate,LCS.table$KDA.Ratio,method="pearson") #Pearson correlation for KDA ratio
cor.test(LCS.table$Win.Rate,LCS.table$Gold.Min,method="pearson") #Pearson correlation for gold per minute
cor.test(LCS.table$Win.Rate,LCS.table$Minions.Killed,method="spearman") #Spearman correlation for minions killed
cor.test(LCS.table$Win.Rate,LCS.table$Champions.Killed,method="spearman") #Spearman correlation for champions killed
```
